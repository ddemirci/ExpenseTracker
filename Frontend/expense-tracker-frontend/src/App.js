...
import ExpenseModule from './components/Modules/ExpensesModule';
import AuthenticationModule from './components/Modules/AuthenticationModule';
...
function App() {
  ...
  return (
    <React.Fragment>
      {isLoggedIn ? <ExpenseModule /> : <AuthenticationModule /> }
    </React.Fragment>
